...
import com.videobox.view.adapter.DMRelatedRecyclerAdapter;
...
public class RelatedFragment extends BaseFragment<Contract.DMPlayerHost> implements Paginate.Callbacks {

    private ArrayList<DMVideoBean> mVideoList = new ArrayList<>();
    private DMRelatedRecyclerAdapter mRecyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.related_fragment, null);
        mRelatedRecyclerView = (RecyclerView) view.findViewById(R.id.related_recyclerview);
        mRecyclerAdapter = new DMRelatedRecyclerAdapter(mVideoList, getActivity());
